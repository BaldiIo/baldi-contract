...
//    }
    ...
    function _availableCurrencyKeysWithOptionalSNX(bool withSNX) internal view returns (bytes32[] memory) {
        ...
        if (withSNX) {
            currencyKeys[availableSynths.length] = "BADI";
        }
...
//            }
    ...
    function _maxIssuableSynths(address _issuer) internal view returns (uint) {
        ...
        uint destinationValue = exchangeRates().effectiveValue("BADI", _collateral(_issuer), sUSD);
    ...
    function _collateralisationRatio(address _issuer) internal view returns (uint, bool) {
        ...
        (uint debtBalance, , bool anyRateIsInvalid) = _debtBalanceOfAndTotalDebt(_issuer, "BADI");
        ...
        returns (uint transferable, bool anyRateIsInvalid)
    {
        ...
        uint debtBalance;
        (debtBalance, , anyRateIsInvalid) = _debtBalanceOfAndTotalDebt(account, "BADI");
    ...
    function liquidateDelinquentAccount(
        ...
        // What is the value of their SNX balance in sUSD?
        uint collateralValue = exchangeRates().effectiveValue("BADI", collateralForAccount, sUSD);
        ...
        uint snxRedeemed = exchangeRates().effectiveValue(sUSD, amountToLiquidate, "BADI");
